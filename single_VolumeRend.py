...
tf.add_layers(4, w=0.03, colormap="Hue Sat Value 2") #You can mess with this to see how other colormaps work with your data
...
cam.snapshot("%s_volume_rendered.png" % ds, clip_ratio=8.0) #outputs to same directory as python script
